...
unlocked to sign the Shiabit-Qt.app bundle.
...
allowing somebody to distribute a Shiabit-Qt.app or shiabit-qt-setup.exe with a valid
...
that the shiabit-qt.exe file inside the installer had not been tampered with.
