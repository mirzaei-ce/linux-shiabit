Shiabit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/shiabit/files/Shiabit/shiabit-0.5.4/
...
http://gitorious.org/shiabit/shiabitd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Shiabit-Qt notifications under Growl 1.3.
Increase required age of Shiabit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxShiabit properly when installing Shiabit-Qt over it. (Windows)
