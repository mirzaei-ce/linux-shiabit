Shiabit Core version 0.9.4 is now available from:

  https://shiabit.org/bin/0.9.4/
...
this update is incompatible with the Shiabit system and could lead to consensus
forks.

Shiabit Core released binaries from https://shiabit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~shiabit/+archive/ubuntu/shiabit
- A third-party or self-compiled Shiabit Core

upgrade to Shiabit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
