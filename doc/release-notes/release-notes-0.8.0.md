Shiabit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/shiabit/files/Shiabit/shiabit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Shiabit
...
New/changed settings (command-line or shiabit.conf file)
--------------------------------------------------------
