...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/shiabit"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Shiabit Core"),
     ...
     * override -datadir in the shiabit.conf file in the default data directory
     * (to be consistent with shiabitd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
