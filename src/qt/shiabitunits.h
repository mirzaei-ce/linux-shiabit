...
#ifndef SHIABIT_QT_SHIABITUNITS_H
#define SHIABIT_QT_SHIABITUNITS_H
...
/** Shiabit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ShiabitUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ShiabitUnits(QObject *parent);

    /** Shiabit units.
      @note Source: https://en.shiabit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        SBT,
...
typedef ShiabitUnits::Unit ShiabitUnit;

#endif // SHIABIT_QT_SHIABITUNITS_H
