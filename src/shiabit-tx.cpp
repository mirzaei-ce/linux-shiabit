...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Shiabit Core shiabit-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  shiabit-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded shiabit transaction") + "\n" +
              "  shiabit-tx [options] -create [commands]   " + _("Create hex-encoded shiabit transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded shiabit transaction
