...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CShiabitAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CShiabitAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CShiabitAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CShiabitAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CShiabitAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CShiabitAddress(arr[0].get_str()).Get() == demoAddress.Get());
