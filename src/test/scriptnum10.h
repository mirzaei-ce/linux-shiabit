...
#ifndef SHIABIT_TEST_SCRIPTNUM10_H
#define SHIABIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Shiabit Core 0.10.0, for cross-comparison.
 */
public:
