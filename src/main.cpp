...
#if defined(NDEBUG)
# error "Shiabit cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Shiabit Signed Message:\n";
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s SBT additional fees, %d delta bytes\n",
